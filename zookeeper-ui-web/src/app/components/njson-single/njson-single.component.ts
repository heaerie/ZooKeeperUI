...
@Component({
  selector: 'app-njson-single',
  templateUrl: './njson-single.component.html',
  styleUrls: ['./njson-single.component.css']
})
export class NjsonSingleComponent implements OnInit {
  @Input() node: Node;
  editing: boolean;
  modalRef: BsModalRef;
  alerts: AlertList;
